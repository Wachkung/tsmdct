                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span>ระบบจองห้องประชุม <i class="caret"></i></span>
                            </a>
            ...
            <aside class="left-side sidebar-offcanvas">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active">
                            <a href="room_add.php">
                                <i class="fa fa-edit"></i> <span>บันทึกขอห้องประชุม</span>
                            </a>
                        </li>
                        <li class="active">
                            <a href="frm_room.php">
                                <i class="fa fa-print"></i> <span>รายงานการขอใช้ห้องประชุม</span>
                            </a>
                        </li>
 <!-- 
						<li class="active">
                            <a href="risk_bkreport.php">
                                <i class="fa fa-th"></i> <span>ความเสี่ยงส่งมาหน่วยงาน</span>
                            </a>
                        </li>
-->
                    </ul>
