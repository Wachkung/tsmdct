...
$budget=$_POST['budget'];
 if ($_POST['budget'] == '') {$budget='N';}
					$strSQL = "update  meeting_list set idcard='$idcard',depart='$depart',strdate='$strdate',enddate='$enddate',strtime='$strtime',endtime='$endtime',room='$room',room_type='$room_type',name='$name',qty='$qty',conduct_2_qty='$conduct_2_qty',conduct_3_qty='$conduct_3_qty',conduct='$conduct',conduct_1='$conduct_1',conduct_2='$conduct_2',conduct_3='$conduct_3',computer='$computer',budget='$budget',mstatus='Y' where id='$id'	";
					$objQuery = mysql_query($strSQL);
					echo"<meta http-equiv='refresh' content='0;URL=room_edit.php?id=$id&idcard=$idcard'>";
					mysql_close();					
?>