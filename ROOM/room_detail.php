            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="room_detail.php">ให้บริการ</a></li>
                                ...
                                <div class="box-body">
									<div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="strdate" name="strdate" value="<?=$objResult["strdate"]; ?>"disabled="disabled"/> 
											<div class="input-group-addon"> 
												ถึงวันที่   :</i>
                                            </div>
											<input type="text" class="form-control" id="enddate" name="enddate" value="<?=$objResult["enddate"]; ?>"disabled="disabled"/>
										</div><!-- /.input group -->
                                    </div><!-- /.form group -->
									...
									<div class="form-group">
                                        <div class="input-group">
											<div class="input-group-addon"> 
                                           	...
                                           	<input type="text" class="form-control pull-right"name="strtime"value="<?=$objResult["strtime"]; ?>" disabled="disabled" />  
											<div class="input-group-addon"> 
												ถึงเวลา   :</i>
                                            </div>
											<input type="text" class="form-control pull-right"name="endtime"value="<?=$objResult["endtime"]; ?>" disabled="disabled" />
										</div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                     ...
                                     <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select name="idcard" class="form-control" disabled="disabled">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select name="depart" class="form-control" disabled="disabled">
									...
									<div class="form-group">
										<div class="input-group">
                                            ...
                                            <select name="roomtype" class="form-control" disabled="disabled">
									...
									<div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="name"value="<?=$objResult["name"]; ?>"disabled="disabled"/> 
											<div class="input-group-addon"> 
												จำนวน :</i>
                                            </div>
                                           	<input type="text" class="form-control"name="qty"value="<?=$objResult["qty"]; ?>" disabled="disabled" />
										</div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon">
											  ...
											  <label class="form-control">
												<input name="conduct" type="radio" value="Y" <?php if ($objResult['conduct'] == Y) {echo 'checked';}?> disabled="disabled"> : ผู้จัดรับผิดชอบดำเนินการเอง
											  </label>
											  <label class="form-control">
												<input name="conduct" type="radio" value="N"<?php if ($objResult['conduct'] == N) {echo 'checked';}?> disabled="disabled"> : ประสงค์ให้งานธุรการดำเนินการ
											  </label>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon">
											  ...
											  <label class="form-control">
												<input name="conduct_1" type="checkbox" value="Y"<?php if ($objResult['conduct_1'] == Y) {echo 'checked';}?> disabled="disabled"> : จัดสถานที่ประชุม 
											  </label>
											  <label class="form-control">
												<input name="conduct_2" type="checkbox" value="Y"<?php if ($objResult['conduct_2'] == Y) {echo 'checked';}?> disabled="disabled"> : จัดเครื่องดื่ม(น้ำเปล่า) จำนวน 
													<select name="conduct_2_qty" disabled="disabled">
											  ...
											  <label class="form-control">
												<input name="conduct_3" type="checkbox" value="Y"<?php if ($objResult['conduct_3'] == Y) {echo 'checked';}?> disabled="disabled"> : จัดเครื่องดื่มพร้อมอาหารว่าง จำนวน 
													<select name="conduct_3_qty" disabled="disabled">
											  ...
											  <label class="form-control">
												<input name="computer" type="checkbox" value="Y"<?php if ($objResult['computer'] == Y) {echo 'checked';}?> disabled="disabled"> : จัดเครื่องคอมพิวเตอร์ 
											  </label>
										</div><!-- /.input group -->
                                    </div><!-- /.form group -->
									...
									<div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon">
											  ...
											  <label class="form-control">
												<input type="radio" name="budget" id="budget" value="1"<?php if ($objResult['budget'] == 1) {echo 'checked';}?> disabled="disabled" > : เงินบำรุงของบริษัท
											  </label>
											  <label class="form-control">
												<input type="radio" name="budget" id="budget" value="2"<?php if ($objResult['budget'] == 2) {echo 'checked';}?> disabled="disabled"> : เงินสนับสนุน/โครงการของผู้จัด
											  </label>
											  <label class="form-control">
												<input type="radio" name="budget" id="budget" value="3"<?php if ($objResult['budget'] == 3) {echo 'checked';}?> disabled="disabled" > : ไม่เสียงบประมาณ(ประชุมภายใน รพ. ขอเฉพาะน้ำดื่ม)
											  </label>
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                </div><!-- /.box-body -->
