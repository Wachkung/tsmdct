                                    ...
                                    <table id="example1" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="5%"align="center">HISTORY</th>
                                                ...
                                                <th width="5%"align="center">NUTRITION</th>
                                                <th width="5%"align="center">MITTING</th>
                                        ...
                                        <?php
											$total=0; $no=1;
											$sql="SELECT * FROM dch.user_datacenter "; 
										...
										?>
                                            <tr>
                                                ...
                                                <td align="center"><?=$data['HISTORY']?></td>
                                                ...
                                                <td align="center"><?=$data['MITTING']?></td>
