						...
						<tbody>
								<div class="box">
									<div class="box-header"align="center">
										<h3 class="box-title">รายงาน NCD เบาหวาน+ความดัน ในเขต รพ. </h3>Excel Created <a href="frm_ncddmhtshow_excel.php?sdate=<?=$sdate?>&edate=<?=$edate?>">Click here</a> to Download.
									</div><!-- /.box-header -->
