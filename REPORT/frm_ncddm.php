                       ...
                       <section class="col-lg-10 connectedSortable">    
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">รายงาน NCD เบาหวาน ในเขต รพ.</h3>
                                </div>
                                
                                <div class="box-body">
                                	<!-- Date and time range -->
                                    <form action="frm_ncddmshow.php" method="post" enctype="multipart/form-data" name="frmMain" onSubmit="JavaScript:return validate();">
