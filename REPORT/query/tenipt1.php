...
$query="SELECT  
	...
	ipt.prediag as icd10, 
	icd101.icd10name
FROM icd101 INNER JOIN ipt ON icd101.icd10 = ipt.prediag
WHERE   date(ipt.dchdate)  BETWEEN '$year2'  and  '$year2_1' AND NOT (ipt.prediag like 'V%' OR ipt.prediag  LIKE 'W%'OR ipt.prediag  LIKE 'X%'OR ipt.prediag  LIKE 'Y%')
	 and ipt.prediag not in( 'Z370','Z232','Z246','Z380','Z348','O800'
,'Z480','Z133','Z00','Z242','U77')
GROUP BY ipt.prediag ORDER BY cns desc limit 20
