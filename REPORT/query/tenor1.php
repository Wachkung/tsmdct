...
$query="SELECT  
	...
	count(ors.postopdx) AS cns, 
	icd101.icd10name, 
	ors.postopdx as icd10
FROM icd101 INNER JOIN ors ON icd101.icd10 = ors.postopdx
WHERE date(ors.opdate) between '$year2' and  '$year2_1'    
GROUP BY ors.postopdx
