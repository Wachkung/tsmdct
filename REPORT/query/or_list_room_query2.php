...
CONCAT(orrgtx.posit_or,orrgtx.chkhand,orrgtx.chkfoot) as posit_or,
...
FROM
(SELECT orrgt.ans, orrgt.dct, orrgt.roomor, orrgt.dttmor, orrgt.hn, orrgt.vn, orrgt.icd10, dct.fname as docname, orrgt.chkoffor, orrgt.qor
...
IF(orrgt.chkfdt='1','Thigh',IF(orrgt.chkfdt = '2','Leg ',IF(orrgt.chkfdt = '3','Ankle',IF(orrgt.chkfdt = '4','Foot','')))) as chkfdt1
 ...
 FROM hi.orrgt LEFT JOIN hi.dct ON dct.lcno = orrgt.dct WHERE orrgt.chkoffor <> 1 AND orrgt.roomor = 2   ) as orrgtx
LEFT JOIN hi.pt ON orrgtx.hn = pt.hn
LEFT JOIN hi.orfupr ON orrgtx.vn = orfupr.vn
left JOIN hi.icd9cm2 ON icd9cm2.icd9cm = orfupr.icd9cm  
