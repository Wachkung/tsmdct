...
FROM
hi.grdmht
LEFT JOIN (SELECT ovstdx.icd10, ovstdx.vn, ovst.hn, ovst.vstdttm FROM hi.ovst LEFT JOIN hi.ovstdx ON ovst.vn = ovstdx.vn WHERE date(ovst.vstdttm) BETWEEN '$sy10' AND '$ey09' AND grdmht.grschizo  = $type) AS dx
