...
from(SELECT
(case 
when  aaa.age  between'0'and '10' then '0-10'
when  aaa.age  between'11'and '20' then '11-20'
when  aaa.age  between'21'and '30' then '21-30'
when  aaa.age  between'31'and '40' then '31-40'
when  aaa.age  between'41'and '50' then '41-50'
when  aaa.age  between'51'and '60' then '51-60'
when  aaa.age  between'61'and '70' then '61-70'
when  aaa.age  >70 then '>70'
ELSE
''
end ) as agegroup,
aaa.hn,
...
aaa.an
  from(select
-- FLOOR(DATEDIFF(curdate(), brthdate) / 365.25) BETWEEN '0' and '10' AS a10,
-- FLOOR(DATEDIFF(curdate(), brthdate) / 365.25) BETWEEN '11' and '20' AS a20,
-- FLOOR(DATEDIFF(curdate(), brthdate) / 365.25) BETWEEN '21' and '40' AS a40,
-- FLOOR(DATEDIFF(curdate(), brthdate) / 365.25) BETWEEN '50' and '60' AS a60,
-- FLOOR(DATEDIFF(curdate(), brthdate) / 365.25) BETWEEN '70' and '120' AS a100,
...
INNER JOIN ors ON pt.hn = ors.hn where an>0 and orno>0 
 and year(ors.opdate)between '$startyear1' and  '$endyear'
