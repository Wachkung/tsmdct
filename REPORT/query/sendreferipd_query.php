...
GROUP BY vn
ORDER BY hi.ovst.hn DESC) as a  INNER join pt on pt.hn = a.hn ) as b INNER JOIN tumbon ON tumbon.amppart = b.amppart AND tumbon.tmbpart = b.tmbpart
