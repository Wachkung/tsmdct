...
from(SELECT hi.iptdx.icd10, 
	count(iptdx.icd10) AS can, 
	hi.ipt.vn, 
	hi.ipt.hn, 
  hi.ipt.an,
	hi.ipt.dchdate as accdate
FROM hi.iptdx INNER JOIN hi.ipt ON hi.ipt.an = hi.iptdx.an
WHERE iptdx.itemno = 1 and ipt.dchtype = 4 and ipt.dchdate
between '$start' and '$end'
GROUP BY ipt.an
ORDER BY can DESC) as a  INNER join pt on pt.hn = a.hn ) as b INNER JOIN tumbon ON tumbon.amppart = b.amppart AND tumbon.tmbpart = b.tmbpart
