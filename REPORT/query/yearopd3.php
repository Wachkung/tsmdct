...
$query="SELECT $y2+543 AS yearvst, 
	count(DISTINCT(ovst.hn)) AS hn, 
	count(ovst.vn) AS vn, 
 
	ovst.vstdttm
FROM ovst
WHERE DATE_FORMAT(ovst.vstdttm,'%Y-%m-%d') between '$year4' and '$year4_1'
 
	union
        SELECT $y1+543 AS yearvst, 
	count(DISTINCT(ovst.hn)) AS hn, 
	count(ovst.vn) AS vn, 
 
	ovst.vstdttm
FROM ovst
WHERE DATE_FORMAT(ovst.vstdttm,'%Y-%m-%d') between '$year3' and '$year3_1'
 
	union
 SELECT  $Y+543 AS yearvst, 
	count(DISTINCT(ovst.hn)) AS hn, 
	count(ovst.vn) AS vn, 
 
	ovst.vstdttm
FROM ovst
WHERE DATE_FORMAT(ovst.vstdttm,'%Y-%m-%d') between '$year2' and '$year2_1'
