<?php
	...
	$strSQL = " SELECT * FROM nutrition WHERE nutrition_id = '$nutrition_id' ";
	$objQuery = mysql_query($strSQL);
	$objResult = mysql_fetch_array($objQuery);

	$nutrition_id=$objResult['nutrition_id'];
	$nutrition_name=$objResult['nutrition_name'];
	$nutrition_sex=$objResult['nutrition_sex'];
	$nutrition_hn=$objResult['nutrition_hn'];
	$nutrition_date=$objResult['nutrition_date'];
	$nutrition_dx=$objResult['nutrition_dx'];
	$nutrition_fbs=$objResult['nutrition_fbs'];
	$nutrition_bp=$objResult['nutrition_bp'];
	$nutrition_bvn=$objResult['nutrition_bvn'];
	$nutrition_cr=$objResult['nutrition_cr'];
	$nutrition_tc=$objResult['nutrition_tc'];
	$nutrition_tg=$objResult['nutrition_tg'];
	$nutrition_ldl=$objResult['nutrition_ldl'];
?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <?php include "navigator.php";?>
            ...
            <aside class="right-side">
                ...
                <section class="content"> 
                 	<div class="row"> 
                	<form method="post" enctype="multipart/form-data"   action="nutrition_update.php" name="frmMain" onSubmit="JavaScript:return fncSubmit();" >           
                       <section class="col-lg-5 connectedSortable">    
                            <div class="box box-solid box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">แก้ไขข้อมูลผู้ป่วย </h3>
                                </div>
                                <div class="box-body">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="nutrition_hn" value="<?=$objResult["nutrition_hn"];?>"  />
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                     ...
                                     <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" name="nutrition_name" value="<?=$objResult["nutrition_name"];?>" />
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select name="nutrition_sex" class="form-control">
                                              <option value="<?=$objResult["nutrition_sex"];?>" ><?=$objResult["nutrition_sex"];?></option>
                                     ...
                                     <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control"data-inputmask="'alias': 'yyyy-mm-dd'" data-mask name="nutrition_date" value="<?=$objResult["nutrition_date"];?>" />
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select name="nutrition_dx" class="form-control">
                                              <option value="<?=$objResult["nutrition_dx"];?>" ><?=$objResult["nutrition_dx"];?></option>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control"   name="nutrition_fbs"value="<?=$objResult["nutrition_fbs"];?>"  />
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control"   name="nutrition_bp" value="<?=$objResult["nutrition_bp"];?>" />
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control"   name="nutrition_bvn" value="<?=$objResult["nutrition_bvn"];?>" />
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control"   name="nutrition_cr" value="<?=$objResult["nutrition_cr"];?>" />
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control"   name="nutrition_tc" value="<?=$objResult["nutrition_tc"];?>" />
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control"   name="nutrition_tg" value="<?=$objResult["nutrition_tg"];?>" />
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control"   name="nutrition_ldl" value="<?=$objResult["nutrition_ldl"];?>" />
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                </div><!-- /.box-body -->
                                <div class="box-footer">
                                	<div class="form-group">
									    <input name="nutrition_id" type="hidden" class="form-control"  value="<?=$nutrition_id?>">
