                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">รายงานความเสี่ยงที่ลงระดับความรุนแรงทั้งสองด้าน </h3>
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <?php
											$total=0; $no=1;
											$sql="SELECT * FROM risk2_datarisk WHERE risk2_datarisk.commen <> '0' AND risk2_datarisk.typereport <> '0'   order by daterigter DESC"; 
