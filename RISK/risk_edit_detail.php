                     ...
                     <div class="row">   
                       <section class="col-lg-10 connectedSortable">    
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                	<!-- Date and time range -->
                                    <form action="risk_edit_update.php" method="post" enctype="multipart/form-data" name="frmMain" onSubmit="JavaScript:return validate();">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                              ...
                                              <?php
												  $sqlperson2=" SELECT * FROM person  where personla <> ' ' order by name ASC "; 
                                    ...
                                    <div class="form-group">
                                    	...
                                    	<button type="button" class="btn btn-success" onclick="window.location.href='risk_report.php'" >กลับหน้ารายงานรอแก้ไข</button>
                                    </div><!-- /.form group -->
                                </form>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
