                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <?php
											$total=0; $no=1;
											$sql=" SELECT * FROM risk2_datarisk WHERE (risk2_datarisk.commen IN ('A','B','C','D') OR risk2_datarisk.typereport IN ('A','B','C','D')) AND (daterigter BETWEEN '".$strdate."'and '".$enddate."')  order by daterigter DESC "; 
										...
										?>
                                               ...
                                               <td><a href="risk_delete.php?id=<?=$data['id']?>" title="<?=$data['notepatient']?>"onclick="return confirm('ลบข้อมูลหรือไม่');"><span class="label label-primary"> <i class="fxa fa-trash-o"></i></span></a></td>
