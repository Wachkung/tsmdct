                     ...
                     <div class="row">   
                       <section class="col-lg-6 connectedSortable">    
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                	<!-- Date and time range -->
                                    <form action="levelclinic_save.php" method="post" enctype="multipart/form-data" name="frmMain" onSubmit="JavaScript:return validate();">
                                    <div class="form-group">
									  ...
									  <div class="form-group">
                                        <div class="input-group">
											...
											<textarea name="nameclinic" cols="47" rows="3" class="form-control" id="nameclinic"></textarea>
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
