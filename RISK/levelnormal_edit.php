                     ...
                     <div class="row">   
                       <section class="col-lg-6 connectedSortable">    
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                	<!-- Date and time range -->
                                    <form action="levelnormal_update.php" method="post" enctype="multipart/form-data" name="frmMain" 
                                    ...
                                    <div class="form-group">
									  ...
									  <div class="form-group">
                                        <div class="input-group">
											...
											<textarea name="namenormal" cols="47" rows="4" class="form-control" id="namenormal"><?=$objResult["name"];?></textarea>
