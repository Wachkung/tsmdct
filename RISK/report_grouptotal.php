                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">รายงานจำนวนความเสี่ยงแยกตามโปรแกรม</h3>
                                </div><!-- /.box-header -->
                                    ...
                                    <table id="example1" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="15%"align="center">โปรแกรมความเสี่ยง</th>
                                        ...
                                        <?php  
											...
											$sql="SELECT
														...
														COUNT(CASE WHEN risk2_datarisk.datereport BETWEEN '2017-09-01' AND '2017-09-31' THEN '08' END) AS 'กันยายน',
														COUNT(CASE WHEN risk2_datarisk.datereport BETWEEN '2016-10-01' AND '2016-10-31' THEN '08' END) AS 'ตุลาคม',
														COUNT(CASE WHEN risk2_datarisk.datereport BETWEEN '2016-11-01' AND '2016-11-31' THEN '08' END) AS 'พศจิกายน',
														COUNT(CASE WHEN risk2_datarisk.datereport BETWEEN '2016-12-01' AND '2016-12-31' THEN '08' END) AS 'ธันวาคม'
														FROM
														risk2_datarisk
