                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">รายงานความเสี่ยง รอการแก้ไข</h3>
                                </div><!-- /.box-header -->
                                    ...
                                    <table id="example1" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                ...
                                                <th width="35%">การอธิบาย</th>
                                                <th width="5%">คลินิก</th>
                                                <th width="5%">ทั่วไป</th>
                                                <th width="15%">ผู้รับรายงาน</th>
                                                <th width="13%">วันที่ประสบเหตุ</th>
                                        ...
                                        <?php  
											$total=0; $no=1;
											$sql=" SELECT * FROM risk2_datarisk where noteceo = ' ' order by daterigter DESC "; 
										...
										?>
                                                ...
                                                <td><?=$data['commen']?></td>
                                                <td><?=$data['typereport']?></td>
										<?php 
											/*
											$sqldepartreport2=" SELECT * FROM rm_depart where code = '$departreport'"; 
											$resultdepartreport2 = mysql_query($sqldepartreport2); $datadepartreport2 = mysql_fetch_array($resultdepartreport2)
											<td><?=$datadepartreport2['depart']?></td>
											*/
										?>
										...
										?>
                                               ...
                                               <td><a href="risk_edit_detail.php?id=<?=$data['id']?>" title="<?=$data['dataevent']?>"><span class="label label-primary"><i class="fa fa-edit"></i></span></a></td>
                                            </tr>
                                        <?php $no++; } ?>
                                        </tbody>
                                    </table>
