...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td bgcolor="#CCCCCC"> &nbsp;&nbsp;<strong class="unnamed1">รายงานอุบัติการณ์ความเสี่ยงจัดอันดับควาามเสี่ยง</strong></td>
  </tr>
</table>
<br>
...
$URL="reportorder_1.php?daymonthyear1="+document.forms[0].daymonthyear1.value+"&exp="+exporttype+"&daymonthyear2="+document.forms[0].daymonthyear2.value;
