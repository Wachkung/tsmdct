...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td bgcolor="#CCCCCC"> &nbsp;&nbsp;<strong class="unnamed1">รายงานแยกตามระดับความรุนแรงทั่วไป</strong></td>
  </tr>
</table>
<br>
<form name="form1" method="post" action="report7.php">
  <div align="center" class="unnamed1">
    ...
    if (!document.layers) {
     document.write("<input type=button onclick='popUpCalendar(this, form1.daymonthyear2, \"dd/mm/yyyy\")' value=' Date ' style='font-size:11px'>")
          ...
          <tr class="unnamed1">
            <td bgcolor="#BDDCEC">ระดับความรุนแรงคลีนิค</td>
          </tr>
          <tr class="unnamed1">
            <td><select name="code" id="code">
              <option value="0">กรุณาระบุระดับความรุนแรงคลีนิค</option>
              <?
...
$URL="report7_1.php?daymonthyear1="+document.forms[0].daymonthyear1.value+"&exp="+exporttype+"&daymonthyear2="+document.forms[0].daymonthyear2.value+"&code="+document.forms[0].code.value;
