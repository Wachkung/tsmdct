  ...
  <div align="center" class="unnamed1">
    ...
    if (!document.layers) {
     document.write("<input type=button onclick='popUpCalendar(this, form1.daymonthyear2, \"dd/mm/yyyy\")' value=' Date ' style='font-size:11px'>")
          ...
          <tr class="unnamed1">
            <td bgcolor="#BDDCEC">ระดับความรุนแรงทั่วไป</td>
          </tr>
          <tr class="unnamed1">
            <td><select name="code" id="code">
              <option value="0">กรุณาระบุระดับความรุนแรงทั่วไป</option>
              <?
...
$URL="report8_1.php?daymonthyear1="+document.forms[0].daymonthyear1.value+"&exp="+exporttype+"&daymonthyear2="+document.forms[0].daymonthyear2.value+"&code="+document.forms[0].code.value;
