...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td bgcolor="#CCCCCC"> &nbsp;&nbsp;<strong class="unnamed1">รายงานแยกตามหน่วยงานที่ทำการรับผิดชอบ</strong></td>
  </tr>
</table>
<br>
...
$URL="report3_1.php?daymonthyear1="+document.forms[0].daymonthyear1.value+"&exp="+exporttype+"&daymonthyear2="+document.forms[0].daymonthyear2.value+"&departreport="+document.forms[0].departreport.value;
