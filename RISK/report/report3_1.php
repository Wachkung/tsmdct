...
?> 
     <br>
     </strong><font color="#FF0000">รายงานอุบัติการณ์ความเสี่ยงที่ทำรับผิดชอบ</font></p>
  <table width="1000" border="1" cellspacing="0" cellpadding="0">
     <tr bgcolor="#FF99FF" class="unnamed1">
      ...
      <td width="10%"><div align="center">ระดับความรุนแรงทางคลินิก</div></td>
       <td width="20%"><div align="center">ระดับความรุนแรงทั่วไป</div></td>
...
`risk2_datarisk`
WHERE
`risk2_datarisk`.`departrespon` =  '$departreport' and `risk2_datarisk`.`statusconfirm` =  '1' and
