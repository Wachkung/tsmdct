...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td bgcolor="#CCCCCC"> &nbsp;&nbsp;<strong class="unnamed1">รายงานแยกตามหน่วยงานที่รับผิดชอบ</strong></td>
  </tr>
</table>
<br>
<form name="form1" method="post" action="report6_1.php">
  <div align="center" class="unnamed1">
    ...
    if (!document.layers) {
     document.write("<input type=button onclick='popUpCalendar(this, form1.daymonthyear2, \"dd/mm/yyyy\")' value=' Date ' style='font-size:11px'>")
          ...
          <tr class="unnamed1">
            <td bgcolor="#BDDCEC">หน่วยงานที่รับผิดชอบ</td>
          </tr>
          <tr class="unnamed1">
            <td><select name="departrespon" id="departrespon">
...
$codedepartrespon = $result[0];
$namedepartrespon = $result[1];

echo"<option value='$namedepartrespon'>$namedepartrespon</option>";
...
$URL="report6_1.php?daymonthyear1="+document.forms[0].daymonthyear1.value+"&exp="+exporttype+"&daymonthyear2="+document.forms[0].daymonthyear2.value+ "&departrespon="+document.forms[0].departrespon.value; 
