...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
    <td bgcolor="#CCCCCC"> &nbsp;&nbsp;<strong class="unnamed1">รายงานแยกตาม ชื้อผู้ลงรายงาน</strong></td>
  </tr>
</table>
<br>
<form name="form1" method="post" action="report5_1.php">
  <div align="center" class="unnamed1">
    ...
    if (!document.layers) {
     document.write("<input type=button onclick='popUpCalendar(this, form1.daymonthyear2, \"dd/mm/yyyy\")' value=' Date ' style='font-size:11px'>")
          ...
          <tr class="unnamed1">
            <td bgcolor="#BDDCEC">ชื่อผู้ลงรายงาน</td>
          </tr>
          <tr class="unnamed1">
			<td valign="middle" align="left" class="text"><input type="text" name="departreport" size="25" class="form" value="<?=$m_search;?>"></td>
          </tr>
        </table></td>
      </tr>
      <tr>
...
$URL="report5_1.php?daymonthyear1="+document.forms[0].daymonthyear1.value+"&exp="+exporttype+"&daymonthyear2="+document.forms[0].daymonthyear2.value+"&m_search="+document.forms[0].departreport.value;
