...
<HTML>
<HEAD>
<TITLE>โปรแกรมบันทึกความเสี่ยง : TanSumHosPiTal.go.th</TITLE>
<?
if ($exp == "HTML") {
 ...
 ?>
  ...
  <table width="650" border="1" cellpadding="0" cellspacing="0" bordercolor="#666666" bordercolordark="#FFFFFF">
    <tr bgcolor="#FFA4FF" class="unnamed1">
      <td><div align="center">รูปแบบความรุนแรงทางคลินิก</div></td>
      <td><div align="center">จำนวนรายงานความเสี่ยง</div></td>
    
    <tr class="unnamed1"><?


$sqla="SELECT * from risk2_risk_level where grouplevel = '1' order by code";
	//echo"$sql";
...
$sql="SELECT count(commen) FROM `risk2_datarisk` WHERE `risk2_datarisk`.`daterigter` BETWEEN '$daymonthyear1' AND '$daymonthyear2' and commen >'0' and commen like '$codelevel' ";
//echo"$sql";
...
echo"      <td><div align=\"left\">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;$codelevel $namelevel  </div></td>";
   echo"   <td><div align=\"center\"><b>$countlevel</b></div></td>";
...
?>
  ...
  <table width="650" border="0" cellspacing="0" cellpadding="0">
    <tr> 
      <?php $monthname=array("มกราคม","กุมภาพันธ์","มีนาคม","เมษายน","พฤษภาคม","มิถุนายน","กรกฎาคม","สิงหาคม","กันยายน","ตุลาคม","พฤศจิกายน","ธันวาคม");?>
      <? 		$day =array("วันจันทร์","วันอังคาร","วันพุธ","วันพฤหัส","วันศุกร์","วันเสาร์","วันอาทิตย์");		?>
      <td class="unnamed1"><div align="right">วันที่ออกรายงาน : <? echo $day[date('w')-1]." ".date('d')." ". $monthname[date('n')-1]." ".(date('Y'))." เวลา ".date('H:i:s');?></div></td>
