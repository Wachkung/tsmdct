...
<br>
<form name="form1" method="post" action="report2_1.php">
...
$URL="report4_1.php?daymonthyear1="+document.forms[0].daymonthyear1.value+"&exp="+exporttype+"&daymonthyear2="+document.forms[0].daymonthyear2.value+"&departreport="+document.forms[0].departreport.value;
