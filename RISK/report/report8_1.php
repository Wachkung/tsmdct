...
$sql="SELECT code, name FROM  risk2_risk_level WHERE code = '$code'and grouplevel='2'";
//echo"$sql";
//$dbname="risk";
  ...
  <table width="1000" border="1" cellspacing="0" cellpadding="0">
    <tr bgcolor="#FF99FF" class="unnamed1">
      ...
      <td width="10%"><div align="center">ระดับความรุนแรงทั่วไป</div></td>
       ...
       <td width="10%"><div align="center">ความเห็น หัวหน้างาน/ฝ่าย</div></td>
...
`risk2_datarisk`
WHERE
`risk2_datarisk`.typereport =  '$typereport' and
