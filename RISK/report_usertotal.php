                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">รายงานจำนวนความเสี่ยงรายเดือน</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-hover">
										...
										?>
												<td><a href="report_userrisk.php?idcard2=<?=$data['name']?>"><?=$dataperson2['title']?><?=$dataperson2['name']?>  <?=$dataperson2['lastname']?></a></td>
