						...
						<tbody>
								<div class="box">
									<div class="box-header"align="center">
										<h3 class="box-title">รายงานจัดการความเสี่ยง. </h3>Excel Created <a href="frm_report_excel.php?sdate=<?=$sdate?>&edate=<?=$edate?>">Click here</a> to Download.
									</div><!-- /.box-header -->
									<div class="box-body table-responsive">
										<table id="example1" class="table table-bordered table-hover">
											...
											<?php   
												...
												WHERE risk2_datarisk.datereport BETWEEN '".$sdate."' and '".$edate."'
												ORDER BY fromevent"; 
