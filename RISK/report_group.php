                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <?php
											$total=0; $no=1;
											$sql=" SELECT * FROM risk2_datarisk WHERE (fromevent = '".$fromevent2."') AND (daterigter BETWEEN '".$strdate."'and '".$enddate."') order by daterigter DESC "; 
