                       ...
                       <section class="col-lg-6 connectedSortable">    
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">บันทึกความรุนแรงด้านทั่วไป</h3>
                                </div>
                                <div class="box-body">
                                	<!-- Date and time range -->
                                    <form action="levelnormal_save.php" method="post" enctype="multipart/form-data" name="frmMain" 
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                           	...
                                           	<input name="codelevel" type="text" class="form-control" >
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
									  <div class="form-group">
                                        <div class="input-group">
											...
											<textarea name="namenormal" cols="47" rows="4" class="form-control" id="namenormal"></textarea>
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
									<div class="form-group">
									    <input name="grouplevel" type="hidden" class="form-control"  value="2">
                        ...
                        <section class="col-lg-6 connectedSortable">  
                            <div class="box">
                                <div class="box-header">
                                    <h3 class="box-title">รายงานความรุนแรงด้านทั่วไป</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                        <?php
											$sql=" SELECT * FROM risk2_risk_level where grouplevel = '2' order by code DESC "; 
                        					$result = mysql_query($sql); while($data = mysql_fetch_array($result)) {
										?>
                                            <tr>
                                                <td><?=$data['code']?> </td>
                                                <td><?=$data['name']?></td>
                                                <td><a href="levelnormal_edit.php?id=<?=$data['id']?>&codelevel=<?=$data['code']?>&namelevel=<?=$data['name']?>"  onclick="return confirm('แก้ไขหรือไม่');"><span class="label label-primary"><i class="fa fa-edit"></i></span></a></td>
                                                <th><a href="levelnormal_delete.php?id=<?=$data['id']?>&codelevel=<?=$data['code']?>&namelevel=<?=$data['name']?>" onclick="return confirm('ลบข้อมูลหรือไม่');" ><i class="fa fa-trash-o"></i></a></th>
