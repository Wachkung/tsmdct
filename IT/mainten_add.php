            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="plan_add.php">บันทึกบำรุงรักษา</a></li>
                ...
                <section class="content">             
                     <div class="row">   
                       ...
                       <form method="post" enctype="multipart/form-data"   action="save_mainten_all.php" 
                                 name="frmMain" onSubmit="JavaScript:return fncSubmit();" >    
                            <div class="box box-solid box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">บันทึกการบำรุงรักษา</h3>
                                </div>
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control"  name="detail_mainten"/>
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                            ...
                            <div class="box box-solid box-primary">
                                    <div class="box-header">
                                        ...
                                        <h3 class="box-title">ปฏิทินการบันทึกบำรุงรักษา</h3>
                                    </div><!-- /.box-header -->
                                    <div class="box-body">
                                        <div id="calendar"></div> 
                                    </div>  <!-- /box-body -->
                        ...
                        <section class="col-lg-6 connectedSortable">  
                            <div class="box box-solid box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">รายการบันทึกการบำรุงรักษา</h3>
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                            	<th width="10%">No.</th>
                                                <th width="22%">วันที่</th>
                                                <th width="40%">รายละเอียด</th>
                                                <th width="5%">รายการ</th>
                                                <th width="23%">ผู้ดำเนินการ</th>
                                        ...
                                        <?php
											$total=0; $no=1;
											$sql=" SELECT DISTINCT * FROM	 it_mainten   group by date_mainten order by date_mainten DESC   "; 
										...
										?>
                                            <tr>
                                                ...
                                                <td><?=$data['detail_mainten']?></td>
                                                <td><small class="badge pull-right bg-purple"> 
                                                <?php  //จำนวนคอมตั้งโต๊ะ
													$sql1 = mysql_query("SELECT * FROM it_mainten where date_mainten='$date_mainten' ");
                                                ...
                                                <th><a href="mainten_edit.php?date_mainten=<?=$data['date_mainten']?>" onclick="return confirm('แก้ไขหรือไม่');" >
