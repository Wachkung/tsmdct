            ...
            <aside class="right-side">
                ...
                <section class="content">             
                     <div class="row">   
                       ...
                       <form method="post" enctype="multipart/form-data"   action="plan_save.php" 
                                 name="frmMain" onSubmit="JavaScript:return fncSubmit();" >    
                            <div class="box box-solid box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">ฟอร์มสร้างแผนงานการบำรุงรักษา</h3>
                                </div>
                                <div class="box-body">
