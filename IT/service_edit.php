<?php 
	...
	$date=date("Y-m-d");
	$id=$_GET['id'];
	$strSQL = "SELECT * FROM it_service WHERE id = '$id' ";
	$objQuery = mysql_query($strSQL);
	$objResult = mysql_fetch_array($objQuery);
	$person=$objResult["person"];

	$strSQL1 = "SELECT * FROM	 person  WHERE idcard = '$person' ";
    ...
    <?php  include "navigator.php";?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                       แก้ไขการให้บริการงาน IT ทั่วไป
                    </h1>
                    <ol class="breadcrumb">
                ...
                <section class="content">             
                     <div class="row">   
                       ...
                       <form method="post" enctype="multipart/form-data"   action="service_update.php" name="frmMain" onSubmit="JavaScript:return fncSubmit();" >    
                                ...
                                <div class="box-body">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control pull-right" id="reservation"  name="date_inform" value="<?=$objResult["date_inform"];?> - <?=$objResult["date_inform"];?>"  />
                                     ...
                                     <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <option value="<?=substr($objResult["time_inform"],0,2);?>">
											<?=substr($objResult["time_inform"],0,2);?> นาฬิกา</option>
                                            ...
                                            <option value="<?=substr($objResult["time_inform"],3,2);?>">
											<?=substr($objResult["time_inform"],3,2);?> นาที</option>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select name="depart" class="form-control" >
                                              <option value="<?=$objResult["depart"];?>"><?=$objResult["depart"];?></option>
                                              <?php
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select name="cause" class="form-control">
												<option value="<?=$objResult["cause"];?>"><?=$objResult["cause"];?></option>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control pull-right" id="reservationtime"  name="date_service" value="<?=$objResult["date_service"];?> - <?=$objResult["date_service"];?>" />
                                        </div><!-- /.input group -->
                                     </div><!-- /.form group -->
                                     ...
                                     <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <option value="<?=substr($objResult["time_service"],0,2);?>"><?=substr($objResult["time_service"],0,2);?> นาฬิกา</option>
                                            <option value="00">00 นาฬิกา</option>
                                            <option value="01">01 นาฬิกา</option>
                                            <option value="02">02 นาฬิกา</option>
                                            <option value="03">03 นาฬิกา</option>
                                            ...
                                            <option value="<?=substr($objResult["time_service"],3,2);?>"><?=substr($objResult["time_service"],3,2);?> นาที</option>
                                            <option value="00">00 นาที</option>
                                            <option value="10">10 นาที</option>
                                            <option value="20">20 นาที</option>
                                            <option value="30">30 นาที</option>
                                     ...
                                     <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <textarea name="detail_service" cols="" rows="3" class="form-control"><?=$objResult["detail_service"];?></textarea>
                                        </div><!-- /.input group -->
                                     </div><!-- /.form group -->
                                     ...
                                     <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <option value="<?=$objResult["person_service"];?>"><?=$objResult["person_service"];?></option>
