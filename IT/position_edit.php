<?php
	...
	$PosId=$_GET['PosId']; 
	$strSQL = "SELECT * FROM position WHERE PosId = '$PosId'";
                       ...
                       <section class="col-lg-6 connectedSortable">    
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">บันทึกชื่อตำแหน่ง</h3>
                                </div>
                                <div class="box-body">
                                	<!-- Date and time range -->
                                    <form action="position_update.php" method="post" enctype="multipart/form-data" name="frmMain" 
                                    onSubmit="JavaScript:return validate();">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                                <i class="fa fa-calendar"> ชื่อตำแหน่ง</i>
                                            </div>
                                           	<input name="PosName" type="text" class="form-control" value="<?=$objResult["PosName"];?>" >
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                  
									<div class="form-group">
									    <input name="PosId" type="hidden" class="form-control"  value="<?=$PosId?>">
