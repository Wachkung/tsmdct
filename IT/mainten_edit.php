...
$date=date("Y-m-d");
$date_mainten=$_GET['date_mainten'];

	$strSQL = "SELECT * FROM it_mainten WHERE date_mainten = '$date_mainten' ";
...
<html>
    ...
    <?php  include "navigator.php";?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="plan_add.php">บำรุงรักษา</a></li>
                ...
                <section class="content">             
                     <div class="row">   
                       ...
                       <form method="post" enctype="multipart/form-data"   action="update_mainten_all.php" 
                                 name="frmMain" onSubmit="JavaScript:return fncSubmit();" >    
                            <div class="box box-solid box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">แก้ไขการบำรุงรักษา</h3>
                                </div>
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control pull-right" id="reservationtime"  name="date_mainten" 
                                            value="<?=$date_mainten?>" />
                                        </div><!-- /.input group -->
                                     </div><!-- /.form group -->
                                     ...
                                     <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control"  name="detail_mainten" value="<?=$objResult["detail_mainten"];?>"/>
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select name="person_mainten" class="form-control pull-left"   >
                                              <option value="<?=$objResult["person_mainten"];?>"><?=$objResult["person_mainten"];?></option>
                                ...
                                <div class="box-footer">
                                	<div class="form-group">
                                    <button type="button" class="btn btn-primary" onclick="window.location.href='mainten_add.php'">
                                    <i class="fa fa-plus"></i> เพิ่มใหม่</button>
                                   	<button  type="submit" class="btn btn-success" onclick="return confirm('ต้องการบันทึกการแก้ไขหรือไม่')" >แก้ไขการบันทึก</button>
                                    <button type="button" class="btn btn-danger" onclick="window.location.href='main6.php'">
                                         ย้อนกลับ</button>	
                                 </div><!-- /.form group -->
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                        ...
                        <section class="col-lg-7 connectedSortable">  
                            <div class="box box-solid box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">รายการของวันที่  <?=LongThaiDate($date_mainten)?></h3>
                                </div><!-- /.box-header -->
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <?php   
											$total=0; $no=1;
											$sql=" SELECT it_mainten.id,it_mainten.code,it_mainten.date_mainten,it_mainten.detail_mainten,it_mainten.person_mainten,it_desktop.desktop_code,it_desktop.name,it_desktop.depart FROM it_mainten INNER JOIN it_desktop ON it_mainten.code = it_desktop.desktop_code where date_mainten='$date_mainten'"; 
                        					$result = mysql_query($sql); while($data = mysql_fetch_array($result)) {
											$total=$total+$data['price_repair'];	
										?>
                                            <tr>
                                            	<td><?=$no?></td>
                                                <td><?=LongThaiDate($data['date_mainten'])?></td>
                                                <td><?=$data['desktop_code']?> | <?=$data['name']?> | <?=$data['depart']?>
                                                </td>
                                                <td><?=$data['person_mainten']?></td>
                                            </tr>
                                        <?php  $no++;  } ?>
                                        </tbody>
                                    </table>
        ...
        <script language="javascript">
			function fncSubmit() {
				if(document.frmMain.date_mainten.value == "")
				{	alert(' เลือกวัน ');	
							document.frmMain.date_mainten.focus();
							return false; } 

				if(document.frmMain.detail_mainten.value == "")
				{	alert(' กรอกรายละเอียด ');	
							document.frmMain.detail_mainten.focus();
							return false; } 
							
				if(document.frmMain.person_mainten.value == "")
				{	alert(' เลือกผู้ดำเนินงาน ');	
							document.frmMain.person_mainten.focus();
							return false; } 
			}
			</script>
