...
$date=date("Y-m-d");
	$id=$_GET['id'];
	$strSQL = "SELECT * FROM it_charges WHERE id = '$id' ";
            ...
            <aside class="right-side">
                ...
                <section class="content">             
                     <div class="row">   
                       ...
                       <form method="post" enctype="multipart/form-data"   action="charges_update.php" 
                                 name="frmMain" onSubmit="JavaScript:return fncSubmit();" >    
                            <div class="box box-solid box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">แก้ไขค่าใช้จ่ายอื่นๆ งาน IT วันที่ <?=LongThaiDate($date)?></h3>
                                </div>
                                <div class="box-body">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control pull-right" id="reservation"  name="dupdate" value="<?=$objResult["dupdate"];?> - <?=$objResult["dupdate"];?>"  />
                                            <input type="hidden" class="form-control pull-right"   name="id" value="<?=$id?>"  />
                                        </div><!-- /.input group -->
                                     </div><!-- /.form group -->
                                     ...
                                     <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <textarea name="detail" cols="" rows="3" class="form-control"><?=$objResult["detail"];?></textarea>
                                        </div><!-- /.input group -->
                                     </div><!-- /.form group -->
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control pull-right"   name="price" onKeyPress="CheckNum();"  
                                            placeholder="0"  value="<?=$objResult["price"];?>"/>
                                        </div><!-- /.input group -->
                                     </div><!-- /.form group -->
                                </div><!-- /.box-body -->
