                            ...
                            <div class="small-box bg-blue">
                                <div class="inner">
                                    <h3>
                                        <?php  
											//จำนวนคอมตั้งโต๊ะ
											$sql1 = mysql_query("SELECT * FROM it_desktop  ");
                                ...
                                <a href="desktop.php" class="small-box-footer">
                            ...
                            <div class="small-box bg-blue">
                                <div class="inner">
                                    <h3>
                                         <?php  
											//จำนวนโนตบุ๊ค
											$sql1 = mysql_query("SELECT * FROM it_notebook  ");
											$records1 = mysql_num_rows($sql1);
											echo "$records1";
										?>
                                    </h3>
                                ...
                                <a href="notebook.php" class="small-box-footer">
                                     More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                            ...
                            <div class="small-box bg-blue">
                                <div class="inner">
                                    <h3>
                                         <?php  
											//จำนวน จอคอมพิวเตอร์
											$sql1 = mysql_query("SELECT * FROM it_monitor  ");
											$records1 = mysql_num_rows($sql1);
											echo "$records1";
										?>
                                    </h3>
                        ...
                        <div class="col-lg-3 col-xs-6">
                            ...
                            <div class="small-box bg-blue">
                                <div class="inner">
                                    <h3>
                                         <?php  
											//จำนวนอเครื่องสำรองไฟ
											$sql1 = mysql_query("SELECT * FROM it_ups  ");
											$records1 = mysql_num_rows($sql1);
											echo "$records1";
										?>
                                    </h3>
                                ...
                                <a href="ups.php" class="small-box-footer">
                                     More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                            ...
                            <div class="small-box bg-blue">
                                <div class="inner">
                                    <h3>
                                        <?php  
											//จำนวนเครื่องพิมพ์
											$sql1 = mysql_query("SELECT * FROM it_printer  ");
											$records1 = mysql_num_rows($sql1);
											echo "$records1";
										?>
                                    </h3>
                                ...
                                <a href="printer.php" class="small-box-footer">
                                     More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
                            ...
                            <div class="small-box bg-blue">
                                <div class="inner">
                                    <h3>
                                        <?php  
											//จำนวนเครื่องพิมพ์
											$sql1 = mysql_query("SELECT * FROM it_device  ");
											$records1 = mysql_num_rows($sql1);
											echo "$records1";
										?>
                                    </h3>
                                    <p>
                                        อุปกรณ์ IT อื่นๆที่ดูแล
                                    </p>
                                </div>
                                <div class="icon">
                                    <i class="ion ion-ios7-briefcase-outline"></i>
                                </div>
                                <a href="device.php" class="small-box-footer">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
