            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li><a href="device_detail.php?notebook_code=<?=$objResult["device_code"];?>">รหัส <?=$objResult["device_code"];?></a></li>
                     ...
                     <div class="row">   
                       <section class="col-lg-5 connectedSortable">    
                            <div class="box box-solid box-primary">
                                ...
                                <div class="box-body">
                                	<p align="left"><img  src="picture_device/<?=$objResult["picture"];?>"
                        ...
                        <section class="col-lg-7 connectedSortable">  
                            <div class="box box-solid box-primary">
                                ...
                                <div class="box-body">
                                <form method="post" enctype="multipart/form-data"  action="device_save_repair.php" 
                                ...
                                <div class="box-footer">
                                    ...
                                    onclick="window.location.href='device_detail.php?device_code=<?=$objResult["device_code"]?>'">
                                         ย้อนกลับ</button>	
                                    </div><!-- /.form group -->
                                </div><!-- /.box-footer -->
