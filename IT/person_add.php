                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control"data-inputmask="'alias': 'yyyy-mm-dd'" data-mask name="bdate"/>
                                            <div class="input-group-addon">
                                                วันที่เข้าทำงาน :
                                            </div>
                                            <input type="text" class="form-control" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask name="workdate"/> 
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
