            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">ค่าใช้จ่ายอื่นๆ</li>
                    </ol>
                </section>
                <!-- Main content -->
                        ...
                        <section class="col-lg-6 connectedSortable">  
                            <div class="box box-solid box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    onclick="window.location.href='charges_add.php'">
                                ...
                                <div class="box-footer table-responsive">
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <?php
											$total=0; $no=1;
											$sql=" SELECT * FROM	 it_charges  where dupdate >= '2014-01-01' order by dupdate desc "; 
