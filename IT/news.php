                        ...
                        <div class="col-xs-12">
                            <div class="box box-solid box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">ข้อมูลข่าวประชาสัมพันธ์/ข่าวกิจกรรม</h3>
                                </div><!-- /.box-header -->
                                ...
                                <div class="box-body">
                                    ...
                                    onclick="window.location.href='news_add.php'">
                                    <i class="fa fa-plus"></i> 1.เพิ่ม ข่าวประชาสัมพันธ์/ข่าวกิจกรรม ใหม่</button>	
                                    </div><!-- /.form group -->
                                </div>
                                ...
                                <div class="box-footer table-responsive">
                                    <table id="example1" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                            	<th width="5%">No.</th>
                                                <th width="15%">ประเภทข่าว</th>
                                                <th width="20%">หัวข้อข่าว</th>
                                                <th width="80">เนื่อหาข่าว</th>
                                        ...
                                        <?php    
											$no=1;
											$sql=" SELECT news.id,news_category.category_name,news.topic,news.posted FROM	news INNER JOIN news_category ON news.category=news_category.id order by news.id DESC "; 
										...
										?>
                                            <tr>
                                                ...
                                                <td><?=$data['2']?></td>
                                                <td><?=$data['3']?></td>
                                                <td><a href="news_edit.php?id=<?=$data['id']?>" onclick="return confirm('แก้ไขหรือไม่');" >
                                                <i class="fa fa-edit"></i></a></td>
                                                <td><a href="news_delete.php?id=<?=$data['id']?>" onclick="return confirm('ลบข้อมูลหรือไม่');" >
