									...
									<div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon">
											  ...
											  <label class="form-control">
												<input type="checkbox" name="LA" id="LA" value="1"<?php if ($objResult['LA'] == 1) {echo 'checked';}?> > : LA
											  </label>
											  <label class="form-control">
												<input type="checkbox" name="ROOM" id="ROOM" value="1"<?php if ($objResult['ROOM'] == 1) {echo 'checked';}?> > : ROOM
											  </label>
											  <label class="form-control">
												<input type="checkbox" name="IT" id="IT" value="1" <?php if ($objResult['IT'] == 1) {echo 'checked';}?> > : IT
											  </label>
											  <label class="form-control">
												<input type="checkbox" name="PERSON" id="PERSON" value="1" <?php if ($objResult['PERSON'] == 1) {echo 'checked';}?> > : PERSON
											  </label>
											  <label class="form-control">
												<input type="checkbox" name="NUTRITION" id="NUTRITION" value="1" <?php if ($objResult['NUTRITION'] == 1) {echo 'checked';}?> > : NUTRITION
											  </label>
											  <label class="form-control">
												<input type="checkbox" name="DURABLE" id="DURABLE" value="1" <?php if ($objResult['DURABLE'] == 1) {echo 'checked';}?> > : DURABLE
											  </label>
											  <label class="form-control">
											  ...
											  <label class="form-control">
												<input type="checkbox" name="STATUS" id="STATUS" value="1" <?php if ($objResult['STATUS'] == 1) {echo 'checked';}?> > : STATUS
											  </label>
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                </div><!-- /.box-body -->
