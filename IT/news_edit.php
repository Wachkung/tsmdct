<?php 
	...
	$category1=$objResult["category"];
	$topic=$objResult["topic"];
	$headline=$objResult["headline"];
	$posted=$objResult["posted"];
	$post_date=$objResult["post_date"];
                ...
                <section class="content">             
                     <div class="row">   
                       <section class="col-lg-6 connectedSortable"> 
							<form action="news_update.php" method="post" enctype="multipart/form-data" name="frmMain" onSubmit="JavaScript:return validate();">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                                <i class="fa fa-calendar"> เลือกวันที่</i>
                                            </div>
                                            <input type="text" class="form-control" data-inputmask="'alias': 'yyyy-mm-dd'" data-mask name="post_date"/ value="<?=$post_date?>"> 
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
											...
											<?
												$strSQLcategory = "SELECT * FROM news_category WHERE news_category.id = '$category1'";
												$objQuerycategory = mysql_query($strSQLcategory);
												$objResultcategory = mysql_fetch_array($objQuerycategory);
											?>
		                                        <option value="<?=$objResultcategory["id"];?>"><?=$objResultcategory["category_name"];?></option>
                                            	<option value="">----- เลือกประเภทข่าวสาร -----</option>
                                                <option value="1">ข่าวประชาสัมพันธ์</option>
                                                <option value="2">ข่าวกิจกรรมโรงพยาบาล</option>
                                            </select> 
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                      ...
                                      <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                           	...
                                           	<input name="topic" type="text" class="form-control" value="<?=$topic?>">
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
									  ...
									  <div class="form-group">
                                        <div class="input-group">
											...
											<textarea class="form-control" rows="3" name="headline" type="text"><?=$headline?></textarea>
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
									  ...
									  <div class="form-group">
                                        <div class="input-group">
											...
											<textarea class="form-control" rows="7" name="posted" type="text"><?=$posted?></textarea>
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
									<div class="form-group">
                                    	<input name="update_date" type="hidden" class="form-control"  value="<?=$date?>">
                                    	<input name="id" type="hidden" class="form-control"  value="<?=$id?>">
										<button name="btnSubmit" type="submit" class="btn btn-primary">แก้ไขข่าวสาร</button> 
