                     ...
                     <div class="row">   
                       <section class="col-lg-10 connectedSortable">    
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                	<!-- Date and time range -->
                                    <form action="risk_in_update.php" method="post" enctype="multipart/form-data" name="frmMain" onSubmit="JavaScript:return validate();">
									...
									<div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon">
											 ...
											 <select class="form-control"  name="departreport"disabled="disabled">
											 	<?php
														$sql2="select CODE, DeptName from risk2_departreport where CODE = '$departreport' order by STATUS,DeptName ";
                                            ...
                                            <div class="input-group-addon">
                                           	...
                                           	<select class="form-control"  name="departrespon"disabled="disabled">
											 	<?php
														$sql2="select CODE, DeptName from risk2_departreport where CODE = '$departrespon' order by STATUS,DeptName ";
														$dbquery2 = mysql_db_query($db, $sql2);
														$num_rows2 = mysql_num_rows($dbquery2);
														$i=0;
														while ($i < $num_rows2)
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                           	...
                                           	<select class="form-control"  name="fromevent"disabled="disabled">
												<?php
									...
									<div class="form-group">
                                        <div class="input-group">
											<div class="input-group-addon">
                                           	...
                                           	<select class="form-control"  name="dataevent"disabled="disabled">
												<?php
														...
														while ($i < $num_rows)
															{
																...
																$namerisk = $result[1];
																$coderisk = $result[2];
																echo"<option value='$coderisk'>$namerisk</option>";
																$i++;
															}
														$sql="select codegroup, namerisk,coderisk from risk2_risk order by  namerisk";
														$dbquery = mysql_db_query($db, $sql);
														$num_rows = mysql_num_rows($dbquery);
														$i=0;
														while ($i < $num_rows)
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                           	...
                                           	<select class="form-control"  name="commen"disabled="disabled">
											...
											<div class="input-group-addon">
                                           	...
                                           	<select class="form-control"  name="typereport"disabled="disabled">
                                    ...
                                    <div class="form-group">
                                    	...
                                    	<button type="button" class="btn btn-success" onclick="window.location.href='risk_in_report.php'" >กลับหน้าหลัก</button>
                                    </div><!-- /.form group -->
                                </form>
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
