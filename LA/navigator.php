                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="active">
								<li class="active"><a href="risk_add.php"><i class="fa fa-edit"></i> <span>บันทึกความเสี่ยง</span></a></li>
								<li class="active"><a href="delete_risk.php"><i class="fa fa-trash-o"></i> <span>ลบความเสี่ยง</span></a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="active">
								<li><a href="risk_report.php"><i class="fa fa-arrow-left" aria-hidden="true"></i> <span>ความเสี่ยงที่ส่งรายงาน</span> </a></li>
								<li><a href="risk_in_report.php"><i class="fa fa-arrow-right" aria-hidden="true"></i> <span>ความเสี่ยงที่รับรายงาน</span></a></li>
								<li><a href="frm_report.php"><i class="fa fa-hospital-o" aria-hidden="true"></i> <span>รายงานความเสี่ยงทั้งหมด</span></a></li>
                            </ul>
                        </li>
                    </ul>
                </section>
