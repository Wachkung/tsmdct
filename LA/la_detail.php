                    ...
                    <div class="box box-primary">
                            ...
                            <form action="save_la.php" method="post" enctype="multipart/form-data" name="frmMain" onSubmit="JavaScript:return validate();">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control pull-right"  name="lasasom" value="<?= $objResult["lasasom"]; ?>" readonly/>
                                    </div><!-- /.input group -->
                                </div><!-- /.form group -->
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control pull-right" id="reservation" name="la_date" />
                                    </div><!-- /.input group -->
                                </div><!-- /.form group -->
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input id="num_nights" name="dsum" type="text" class="form-control" onKeyPress="CheckNum()" />
                                    </div><!-- /.input group -->
                                </div><!-- /.form group -->
                        ...
                        <div class="box-footer">
                            ...
                            <table class="table table-bordered" align="center">
								...
								?>
                                    <td align="center"><h3><strong><?php if ($la_day == '') { echo "0"; } else { echo "$la_day";} ?></strong></h3></td>
                                    <?php
                                    //จำนวน ลาป่วย
								...
								while ($data = mysql_fetch_array($result)) {
									?>
                                        <tr>
                                            ...
                                            <td><?= $data['latype'] ?> </td>
                                            <td><?= $data['dsum'] ?></td>
                                            <th><a href="report_la.php?id=<?= $data['id'] ?>&latype=<?= $data['latype'] ?>&dsum=<?= $data['dsum'] ?>&idcard=<?= $data['idcard'] ?>&lasasom=<?= $objResult['lasasom'] ?>" onclick="return confirm('พิมพ์ข้อมูลหรือไม่');" ><span class="label label-primary"><i class="fa fa-print"></i></a></th>
...
<script type="text/javascript">
		function showDays() {
				var str = reservation:$(this).val();
				var start = str.substr(0,10);
				var end = str.substr(13,11);
				if (!start || !end) return;
