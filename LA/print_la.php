                     ...
                     <div class="row">   
                       <section class="col-lg-8 connectedSortable">    
							...
							<table width="100%" border="0" align="center">
							  ...
							  <table width="100%" border="0">
								   <tr>
									 <td scope="col"><div align="right"><font class="fontdoc"><?php echo thai_date($eng_date); ?> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</font></div></td>
								   </tr>
							</table><br>
							<table width="100%" border="0">
								   <tr>
							...
							<table width="100%" border="0">
								   <tr>
									 <td scope="col"><div align="left"><font class="fontdoc">เรียน <?php echo "ผู้อำนวยการ";?><?php echo $namehosp; ?></font></div></td>
								   </tr>
								   <tr>
									 <td scope="col"><div align="left"><font class="fontdoc">&nbsp;</font></div></td>
								   </tr>
							...
							<table width="100%" border="0">
								   <tr>
									 <td  width="300" valign="top" align="center">
										...
										<table width="300" border="0">
											<tr>
												 <td scope="col"><div align="center"><font class="fontdoc"><?php echo "เจ้าพนักงานธุรการชำนาญงาน";?></font></div></td>
											</tr>
										</table>
										<table width="300" border="0">
											<tr>
												 <td scope="col"><div align="center"><font class="fontdoc">วันที่&nbsp;&nbsp;<?php echo "___/____/_______";?>&nbsp;&nbsp;</font></div></td>
											</tr>
										</table>
									 </td>
								<!---------------------------------------------------------------------------------------------------->
									...
									<br>
										...
										<table width="250" border="0">
											<tr>
												 <td scope="col"><div align="left"><font class="fontdoc"><?php echo "อนุญาต/ไม่อนุญาต";?></font></div></td>
											</tr>
										</table>
										<table width="250" border="0">
											<tr>
												 <td scope="col"><div align="left"><font class="fontdoc"><?php echo "____________________________________";?></font></div></td>
											</tr>
										</table>
										<table width="250" border="0">
											<tr>
										...
										<table width="250" border="0">
											<tr>
												 <td scope="col"><div align="center"><font class="fontdoc"><?php echo "หัวหน้าฝ่าย/งาน/กลุ่มงาน";?>.</font></div></td>
											</tr>
										</table>
										<table width="250" border="0">
											<tr>
										...
										<table width="250" border="0">
										  <tr>
											<td scope="col"><div align="center"><font class="fontdoc"><?php echo "อนุญาต/ไม่อนุญาต";?> </font></div></td>
										  </tr>
										</table>
										<table width="250" border="0">
											<tr>
												 <td scope="col"><div align="center"><font class="fontdoc"><?php echo "_____________________________________"?></font></div></td>
											</tr>
										</table>
										<table width="250" border="0">
											<tr>
										...
										<table width="250" border="0">
											<tr>
												 <td scope="col"><div align="center"><font class="fontdoc"><?php echo "ผู้อำนวยการ";?><?php echo $namehosp; ?></font></div></td>
											</tr>
										</table>
										<table width="250" border="0">
											<tr>
												 <td scope="col"><div align="center"><font class="fontdoc">วันที่&nbsp;&nbsp;&nbsp;&nbsp;<input name="con1date" type="hidden" value="<?php echo "";?>"><?php echo "___/____/_______";?></font></div></td>
											</tr>
										</table>
											</td>
								   </tr>
