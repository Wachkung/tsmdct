                     ...
                     <div class="row">   
                       <section class="col-lg-6 connectedSortable">    
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                <p align="left"><img  src="http://www.wkhospital.go.th/2557/registry/person/output/<?=$objResult["idcard"];?>.png" width="104" height="140" class="img-thumbnail"/></p>
                                    ...
                                    <form action="save_lasasom.php" method="post" enctype="multipart/form-data" name="frmMain" onSubmit="JavaScript:return validate();">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input name="lasasom" type="text" class="form-control" onKeyPress="CheckNum()" value="<?=$objResult["lasasom"];?> ">
                                                <input name="idcard" type="hidden" class="form-control"  value="<?=$objResult["idcard"];?>" >												
                                                <div class="input-group-addon">
                                                    <i class="fa "> วัน</i>
                                                </div>
                                            </div><!-- /.input group -->
