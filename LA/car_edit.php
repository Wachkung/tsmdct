<?php
	...
	$strSQLcar = "SELECT * FROM person_car WHERE idcard = '$IDCARD1' and id=$id ";
	$objQuerycar = mysql_query($strSQLcar);
	$objResultcar = mysql_fetch_array($objQuerycar);
?>
                     ...
                     <div class="row">   
                       <section class="col-lg-6 connectedSortable">    
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                	<!-- Date and time range -->
                                    <form action="car_update.php" method="post" enctype="multipart/form-data" name="frmMain" onSubmit="JavaScript:return validate();">
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                                <i class="fa fa-calendar"> เลขทะเบียนรถ :</i>
                                            </div>
                                            <input type="text" class="form-control pull-right" id="car_number" name="car_number"value="<?=$objResultcar["car_number"];?>" />
                                            <div class="input-group-addon">
                                                <i class="fa fa-calendar"> จังหวัด :</i>
                                            </div>
                                            <input type="text" class="form-control pull-right" id="car_city" name="car_city"value="<?=$objResultcar["car_city"];?>" />
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                           	...
                                           	<select class="form-control"  name="car_type">
                                             	<option value="<?=$objResultcar["car_type"];?>"><?=$objResultcar["car_type"];?></option>
									  ...
									  <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                           	...
                                           	<input name="car_ru" type="text" class="form-control" value="<?=$objResultcar["car_ru"];?>">
                                            
                                            <div class="input-group-addon">
                                                <i class="fa fa-calendar-o"> สี :</i>
                                            </div>
                                           	<input name="car_colur" type="text" class="form-control" value="<?=$objResultcar["car_colur"];?>">
									  ...
									  <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                           	...
                                           	<input name="car_yee" type="text" class="form-control" value="<?=$objResultcar["car_yee"];?>">
