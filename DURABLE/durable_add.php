    ...
    <?php  include "navigator.php";?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                       เพิ่มอุปกรณ์ การแพทย์ รหัสใหม่ : <?=$new_device_code?>  
                    </h1>
                    <ol class="breadcrumb">
                ...
                <section class="content"> 
                 	<div class="row"> 
                	<form method="post" enctype="multipart/form-data"   action="durable_save.php" name="frmMain" onSubmit="JavaScript:return fncSubmit();" >            
                       <section class="col-lg-5 connectedSortable">    
                            <div class="box box-solid box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">คุณสมบัติ ครุภัณฑ์ การแพทย์ </h3>
                                </div>
                                <div class="box-body">
                        ...
                        <section class="col-lg-7 connectedSortable"> 
                            <div class="box box-solid box-primary">
                                ...
                                <div class="box-footer">
                                    ...
                                    onclick="window.location.href='durable.php'">
                                         ยกเลิก</button>	
                                    </div><!-- /.form group -->
                                </div><!-- /.box-footer -->
