            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">ครุภัณฑ์ โรงพยาบาล</li>
                    </ol>
                </section>
                            ...
                            <div class="small-box bg-blue">
                                <div class="inner">
                                    <h3>
                                        <?php  
											//จำนวนคอมตั้งโต๊ะ
											$sql1 = mysql_query("SELECT * FROM durable_device where durable_type_code = 'DT105'");
											$records1 = mysql_num_rows($sql1);
											echo "$records1";
										?>
                                    </h3>
                                ...
                                <a href="durable.php" class="small-box-footer">
                                    More info <i class="fa fa-arrow-circle-right"></i>
                                </a>
                            </div>
                        </div><!-- ./col -->
