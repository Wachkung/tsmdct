    ...
    <?php  include "navigator.php";?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                       แก้ไขอุปกรณ์ การแพทย์ รหัส : <?=$objResult["device_code"];?> 
                    </h1>
                    <ol class="breadcrumb">
                ...
                <section class="content"> 
                 	<div class="row"> 
                	<form method="post" enctype="multipart/form-data"   action="durable_update.php" name="frmMain" onSubmit="JavaScript:return fncSubmit();" >            
                       <section class="col-lg-5 connectedSortable">    
                            <div class="box box-solid box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">คุณสมบัติ อุปกรณ์ การแพทย์ อื่นๆ </h3>
                                </div>
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <select name="dtype" class="form-control">
                                              ...
                                              <?php
													$sqldurable=" SELECT * FROM durable where durable_type_code='DT105' order by durable_code ASC "; 
                        ...
                        <section class="col-lg-7 connectedSortable"> 
                            <div class="box box-solid box-primary">
                                ...
                                <div class="box-footer">
                                    ...
                                    <a class="btn btn-warning"  href="durable_delete.php?device_code=<?=$objResult["device_code"];?>&picture=<?=$objResult["picture"];?>"
                                     onclick="return confirm('ต้องการลบ ครุภัณฑ์ หรือไม่')" >ลบครุภัณฑ์</a>
                                    <button type="button" class="btn btn-danger" 
                                    onclick="window.location.href='durable_detail.php?device_code=<?=$device_code?>'">
                                         ยกเลิก</button>	
                                    </div><!-- /.form group -->
                                </div><!-- /.box-footer -->
