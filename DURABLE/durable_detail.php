                            ...
                            <div class="box box-solid box-primary">
                                ...
                                <div class="box-footer">
                                	<div class="form-group">
                                   	<button type="button" class="btn btn-success" onclick="window.location.href='durable_repair.php?device_code=<?=$objResult["device_code"]?>'">1.ซ่อม/อัพเกรด</button>
                                    <button type="button" class="btn btn-success" onclick="window.location.href='durable_edit.php?device_code=<?=$objResult["device_code"]?>'">2.แก้ไขขครุภัณฑ์</button>
                                    <button type="button" class="btn btn-success" onclick="window.location.href='durable_print.php?device_code=<?=$objResult["device_code"]?>'">3.พิมพ์</button>
                                    <button type="button" class="btn btn-danger" onclick="window.location.href='durable.php'"> ย้อนกลับ</button>	
                                    </div><!-- /.form group -->
                                </div><!-- /.box-body -->
                            </div><!-- /.box -->
                        </section><!-- /.Left col -->
