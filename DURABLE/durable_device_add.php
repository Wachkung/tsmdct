<?php
	...
	$strSQL = "SELECT * FROM durable order by durable_code DESC limit 1 ";
	$objQuery = mysql_query($strSQL);
	$objResult = mysql_fetch_array($objQuery);
	
	// สร้างรหัสใหม่
	$new_code=(int)substr($objResult["durable_code"],2,3)+1;
	$key="TS";
                       ...
                       <section class="col-lg-6 connectedSortable">    
                            <div class="box box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">บันทึกเครื่องครุภัณฑ์</h3>
                                </div>
                                <div class="box-body">
                                	<!-- Date and time range -->
                                    <form action="durable_device_save.php" method="post" enctype="multipart/form-data" name="frmMain"  onSubmit="JavaScript:return validate();">
                                        ...
                                        <div class="input-group">
											...
											<span id="durable_type_code">
												<select class="form-control" name="durable_type_code">
													<option value="">- เลือก ประเภทครุภัณฑ์ -</option>
												<?php
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                           	...
                                           	<input name="durable_code" type="text"placeholder="TS100" class="form-control"value="<?=$new_device_code;?>"readonly >
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
									  ...
									  <div class="form-group">
                                        <div class="input-group">
											...
											<textarea name="durable_name" cols="47" rows="3" class="form-control" id="durable_name"></textarea>
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
									<div class="form-group">
										<button name="btnSubmit" type="submit" class="btn btn-primary">บันทึกเครื่องครุภัณฑ์</button> 
