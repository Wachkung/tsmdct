    ...
    <?php  include "navigator.php";?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1>
                        รายการครุภัณฑ์ การแพทย์ อื่นๆ
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="index.php"><i class="fa fa-dashboard"></i> หน้าแรก</a></li>
                        <li><a href="durable.php">ครุภัณฑ์ การแพทย์</a></li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-12">
                            <div class="box box-solid box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">ข้อมูลรายการครุภัณฑ์ การแพทย์ อื่นๆ</h3>
                                </div><!-- /.box-header -->
                                ...
                                <div class="box-body">
                                    ...
                                    onclick="window.location.href='durable_add.php'">
                                    <i class="fa fa-plus"></i> 1.เพิ่มรายการครุภัณฑ์ การแพทย์ อื่นๆ</button>	
                                    </div><!-- /.form group -->
                                </div>
                                ...
                                <div class="box-footer table-responsive">
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <?php    
											$no=1;
											$sql=" SELECT * FROM durable_device  order by id DESC "; 
										...
										?>
                                            <tr>
                                                ...
                                                <td><?=$data['status']?></td>
                                                <td><a href="durable_detail.php?device_code=<?=$data['device_code']?>" title="<?=$data['device_code']?>"><span class="btn bg-green">เลือก</span></a></td>
                                            </tr>
                                        <?php  $no++; } ?>
                                        </tbody>
