...
<html lang="en">
	<head>
		...
		<link href="../includes/bootstrap/plugins/bootstrap/bootstrap.css" rel="stylesheet">
		<link href="../includes/bootstrap/plugins/jquery-ui/jquery-ui.min.css" rel="stylesheet">
		...
		<link href="../includes/bootstrap/plugins/fancybox/jquery.fancybox.css" rel="stylesheet">
		<link href="../includes/bootstrap/plugins/fullcalendar/fullcalendar.css" rel="stylesheet">
		<link href="../includes/bootstrap/plugins/xcharts/xcharts.min.css" rel="stylesheet">
		<link href="../includes/bootstrap/plugins/select2/select2.css" rel="stylesheet">
		...
		<div id="sidebar-left" class="col-xs-2 col-sm-2">
			<ul class="nav main-menu">
				...
				<li>
				 ...
				 <li>
					<a class="ajax-link" href="ajax/calendar1.php">
						 <i class="fa fa-calendar"></i>
						 <span class="hidden-xs">Calendar1</span>
					</a>
				 </li>
                 <li>
					<a class="ajax-link" href="ajax/calendar2.html">
						 <i class="fa fa-calendar"></i>
						 <span class="hidden-xs">Calendar2</span>
					</a>
				 </li>
