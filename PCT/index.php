                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-hover">
                                        ...
                                        <?php  
											$total=0; $no=1;
											$sql=" SELECT risk2_datarisk.* FROM risk2_datarisk JOIN risk2_group on risk2_group.codegroup=risk2_datarisk.fromevent where (risk2_group.grouptype='PCT' OR risk2_datarisk.departreport='D32') and noteceo=' ' order by daterigter DESC "; 
