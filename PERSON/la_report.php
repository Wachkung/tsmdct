                            ...
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <table id="example1" class="table table-bordered table-hover">
										...
										?>
                                            <tr>
                                                <td><a  href="person_detail.php?idcard=<?=$data['idcard']?>" title="<?=$data['name']?>  <?=$data['lastname']?>"><?=$data['name']?>  <?=$data['lastname']?></a></td>
                                                <td><?=$data['idcard']?></td>
											<?php  	
											  ...
											  ?>
                                                ...
                                                <td><?=$data['workdate']?></td>
                                                <td><?=$data['lasasom']?></td>
                                                <td><a href="la_detail.php?idcard=<?=$data['idcard']?>" title="<?=$data['name']?>  <?=$data['lastname']?>"><span class="label label-primary">บันทึกวันลา</span></a></td>
                                            </tr>
                                        <?php } 
										}else{
												$sql=" SELECT * FROM person where personla !=' ' order by id ASC "; 
                        						$result = mysql_query($sql); while($data = mysql_fetch_array($result)) {
												$position2=$data['position'];
										?>
                                            <tr>
