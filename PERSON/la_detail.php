                            ...
                            <div class="box box-primary">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                    	...
                                    	<button type="button" class="btn btn-success" onclick="window.location.href='la_report.php'" >กลับหน้าหลัก</button>
                                    </div><!-- /.form group -->
                                ...
                                <div class="box-footer">
                                    ...
                                    <p> เริ่มทำงานวันที่ <code><?=$objResult["workdate"]?></code></p>
                                    <table class="table table-bordered" align="center">
                                        ...
                                        <tr>
                                        	<?php 
												//จำนวน ลากิจ
												$strSQL1 = "SELECT sum(la.dsum) as dsum_totle FROM la where sdate BETWEEN '".$strdate."'and '".$enddate."'  and  idcard='$idcard' 
												and latype='ลาป่วย'";
                                            ...
                                            <?php
												//จำนวน ลาคลอด
												$strSQL1 = "SELECT sum(la.dsum) as dsum_totle FROM la where sdate BETWEEN '".$strdate."'and '".$enddate."'  and  idcard='$idcard' 
												and latype='ลาคลอด/เลี้ยงดูบุตร' ";
												$objQuery1 = mysql_query($strSQL1);
												$objResult1 = mysql_fetch_array($objQuery1);
												$la_day=$objResult1['dsum_totle'];
											?>
