...
$date=date("Y-m-d");
$id=$_GET['id'];
$strSQL = "SELECT * FROM upload_file  WHERE id = '$id' ";
                       ...
                       <form method="post" enctype="multipart/form-data"   action="file_update.php" 
                            ...
                            <div class="box box-solid box-primary">
                                <div class="box-header">
                                    <h3 class="box-title">ฟอร์มแก้ไขไฟล์</h3>
                                </div>
                                <div class="box-body">
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-addon">
											 ...
											 <select class="form-control"  name="file_depart">
											 	<?php
														$sql2="select CODE, DeptName from risk2_departreport where CODE = '$file_depart' order by DeptName ";
									...
									<div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <option value="<?=$objResult["file_type"];?>""><?=$objResult["file_type"];?>"</option>
